						...
						c.raw.series.forEach(
							function (n, a) {
								...
								var t = {
									...
									e = ('function' == typeof t.lineSmooth
										? t.lineSmooth
										: t.lineSmooth
										? m.Interpolation.monotoneCubic()
										: m.Interpolation.none())(r, o);
								if (
									(t.showPoint &&
							...
							? ((p = v =
									void 0 === f.axisX.type
										? new k.AutoScaleAxis(
												...
												g.normalized.series,
												b,
												k.extend({}, f.axisX, { highLow: t, referenceValue: 0 })
										  )
										: f.axisX.type.call(
												k,
												k.Axis.units.x,
							  ...
							  (p = y =
									void 0 === f.axisY.type
										? new k.AutoScaleAxis(
												...
												g.normalized.series,
												b,
												k.extend({}, f.axisY, { highLow: t, referenceValue: 0 })
										  )
										: f.axisY.type.call(
												k,
												k.Axis.units.y,
					...
					function (Li, Ri, t) {
						...
						(e = this),
							(i = function () {
								...
								var Tt = 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split(
									'_'
								);
								function Pt(t, e) {
									var i;
							...
							(l.types = {}),
								...
								(l.Controller = function (t) {
									return (
										...
										(this.options = this.config.options = u.configMerge(
											l.defaults.global,
										...
										if (
											...
											if (s) {
												...
												var y = t.ctx.measureText(t.ticks[0]).width,
													b = t.ctx.measureText(t.ticks[t.ticks.length - 1])
														.width,
